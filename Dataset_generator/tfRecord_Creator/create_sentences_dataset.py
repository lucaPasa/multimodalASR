...
dataset_mean=np.load('dataset_audio_mean.npy')
dataset_std=np.load('dataset_audio_stdev.npy')

# destination folders
train_dir='/home/storage/Data/MULTI_GRID/soloAudioTfRec/TRAIN_CTC_SENTENCES/'
val_dir='/home/storage/Data/MULTI_GRID/soloAudioTfRec/VAL_CTC_SENTENCES/'
test_dir='/home/storage/Data/MULTI_GRID/soloAudioTfRec/TEST_CTC_SENTENCES/'
...
for file_index, csv_file in enumerate(features_file_list):
	...
	labels_file=csv_file.replace('/multi_audio/','/transcription/').replace('.csv','.transcription')

...
def serialize_sequence(video_sequence,labels):
    # The object we return
    ex = tf.train.SequenceExample()
    # A non-sequential feature of our example
    sequence_length = len(video_sequence)
    ...
    for audio_feat in video_sequence:
...
dataset_mean=np.load('dataset_video_mean.npy')
dataset_std=np.load('dataset_video_stdev.npy')

# destination folders local
#train_dir='/home/storage/Data/MULTI_GRID/TRAIN_CTC_VIDEO_SENTENCES/'
#val_dir='/home/storage/Data/MULTI_GRID/VAL_CTC_VIDEO_SENTENCES/'
#test_dir='/home/storage/Data/MULTI_GRID/TEST_CTC_VIDEO_SENTENCES/'

# destination folders comago
train_dir='/home/lpasa/Data/MULTI_GRID/soloVideoTfRec/TRAIN_CTC_VIDEO_SENTENCES/'
val_dir='/home/lpasa/Data/MULTI_GRID/soloVideoTfRec/VAL_CTC_VIDEO_SENTENCES/'
test_dir='/home/lpasa/Data/MULTI_GRID/soloVideoTfRec/TEST_CTC_VIDEO_SENTENCES/'
...
#phonemes=dictionary.replace('\r',' ').split(' ')
...
for file_index, txt_file in enumerate(features_file_list):
	...
	print('file {:s}'.format(txt_file))

	features=np.loadtxt(txt_file)

	labels_file=txt_file.replace('/video/','/transcription/').replace('.txt','.transcription')
